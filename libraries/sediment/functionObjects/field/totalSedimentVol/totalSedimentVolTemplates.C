...
inline bool Foam::functionObjects::fieldValues::totalSedimentVol::canWeight
(
...
template<class Type>
bool Foam::functionObjects::fieldValues::totalSedimentVol::validField
(
...
Foam::functionObjects::fieldValues::totalSedimentVol::getFieldValues
(
    const word& fieldName,
    const bool mustGet
) const
...
Type Foam::functionObjects::fieldValues::totalSedimentVol::
...
template<class Type, class WeightType>
Type Foam::functionObjects::fieldValues::totalSedimentVol::processValues
(
    const Field<Type>& values,
    const vectorField& Sf,
    const Field<WeightType>& weightField
...
template<class WeightType>
Foam::label Foam::functionObjects::fieldValues::totalSedimentVol::writeAll
(
    const vectorField& Sf,
    const Field<WeightType>& weightField,
...
template<class Type, class WeightType>
bool Foam::functionObjects::fieldValues::totalSedimentVol::writeValues
(
    const word& fieldName,
    const vectorField& Sf,
    const Field<WeightType>& weightField,
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::functionObjects::fieldValues::totalSedimentVol::filterField
(
